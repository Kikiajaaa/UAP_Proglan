...
public class CinemaTicketApp {
    ...
    public CinemaTicketApp() {
        ...
        // Tambahkan label layar di atas kursi
        JLabel lblScreen = new JLabel("LAYAR", SwingConstants.CENTER);
        lblScreen.setOpaque(true);
        lblScreen.setBackground(Color.LIGHT_GRAY);
        lblScreen.setFont(new Font("Arial", Font.BOLD, 14));
        lblScreen.setPreferredSize(new Dimension(0, 30)); // Atur tinggi layar
        seatPanel.add(lblScreen, BorderLayout.NORTH);

        JPanel seatGrid = new JPanel(new GridLayout(4, 4, 10, 10));
